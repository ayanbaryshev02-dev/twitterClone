...
const NewTweet = ({content, onChangeTextInput, onTweet}) => {
    return(
        <div className="p-3 d-flex flex-column" style={{borderBottom: '2px solid whitesmoke'}}>
            ...
            <button onClick={onTweet} style={{alignSelf: 'flex-end', color: 'white', background: '#1D9BF0', borderRadius: 20, border: 'none',}}>Tweet</button>
        </div>
    )
}
